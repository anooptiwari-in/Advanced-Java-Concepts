...
public class EntityList<T> {
	...
	public EntityList(){
		...
		//Comparator<T> comp = new OrderContactNumber<T>();
		//entityList = new TreeSet<T>(new OrderContactNumber<T>());  // Define treeset for auxiliary comparison
		//entityList = new TreeSet<T>(new OrderAccNumber<T>());
	}
	*/
	// add	
	...
	*/
	...
	public static void main(String[] argv){
		System.out.println("Exploring Collections..."); 
		/*
		...
		*/
		...
		list1.addNewEntity(new Emp(100, "xxx", 20000, "99998888", 100L));
		list1.addNewEntity(new Emp(50, "xxx", 20000, "11112222", 90L));
		list1.addNewEntity(new Emp(110, "xxx", 20000, "55556666", 155L));
		//list1.addNewEntity(null);
		//list1.addNewEntity(null);
		System.out.println("From listAll()");
		list1.listAll();

		System.out.println(list1.isExisting(new Emp(100, "yyy", 30000, "11112222", 155L)));
	}
}
